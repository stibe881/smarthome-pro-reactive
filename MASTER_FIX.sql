-- MASTER-FIX: Admin-Status, Haushalt und RLS-Rekursion beheben
...
BEGIN
    ...
    ELSE
        ...
        -- 5. Rekursions-Problem beheben (Hilfsfunktion erstellen)
        EXECUTE 'CREATE OR REPLACE FUNCTION public.get_my_household_id()
        ...
        -- 6. Alte Policies löschen und neue, sichere Policies setzen
        ...
        DROP POLICY IF EXISTS "view_household_members" ON public.family_members;
        ...
        RAISE NOTICE 'ERFOLG: Du bist jetzt Admin und das RLS-Problem ist behoben.';
    END IF;
END $$;
